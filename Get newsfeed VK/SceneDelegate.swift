...
class SceneDelegate: UIResponder, UIWindowSceneDelegate, AuthServiceDelegate {
    ...
    func authServiceSignIn() {
        let storyboard = UIStoryboard.init(name: "NewsfeedViewController", bundle: nil)
        let newsFeedVC: NewsfeedViewController = storyboard.instantiateInitialViewController() as! NewsfeedViewController
